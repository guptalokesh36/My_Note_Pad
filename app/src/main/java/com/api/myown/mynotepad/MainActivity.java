...
import com.api.myown.mynotepad.Adapters.NotesListAdapter;
import com.api.myown.mynotepad.DataBase.RoomDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "yo ho", Toast.LENGTH_SHORT).show();
